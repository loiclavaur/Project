...
<html lang="en">
  ...
  <body>
		...
		<center><table>
			<tr>
				<td class = "ho">Bateau (n°)__</td>
				<td class = "ho" >Vent (km/h)__</td>
				<td class = "ho">Filet (kg)__<td>
				
			</tr>
			<tr>
				<td><?php
			$sqlQuery1 = 'SELECT id FROM `data` WHERE 1';
		
			
			$recipesStatement1 = $bdd->prepare($sqlQuery1);
		...
		?></td>
				<td><?php
			$sqlQuery2 = 'SELECT vent FROM `data` WHERE 1';
		
			
			$recipesStatement2 = $bdd->prepare($sqlQuery2);
		...
		<td><?php
			$sqlQuery3 = 'SELECT filet FROM `data` WHERE 1';
		
			
			$recipesStatement3 = $bdd->prepare($sqlQuery3);
		...
		<td><?php
			$sqlQuery4 = 'SELECT date_dechet FROM `data` WHERE 1';
		
			
			$recipesStatement4 = $bdd->prepare($sqlQuery4);
